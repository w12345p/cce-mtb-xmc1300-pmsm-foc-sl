# XMC&trade;1300: PMSM FOC Sensorless
...
This code example demonstrates the sensorless PMSM FOC motor control application using XMC1300. In order to test this software, [XMC1000 Motor Control Application Kit](https://www.infineon.com/cms/en/product/evaluation-boards/kit_xmc1x_ak_motor_001/#!documents) is needed. This kit includes an XMC1300 board and a PMSM Low Voltage Motor Card with a 3-phase motor. 
...
![](images/hardware-setup-edited.jpg)
...
**Note:** If you want to run the motor without using Micro Inspector Pro application, please change the "**motor_request_start**" flag to "**true**" in line 58 inside main.c file.
...
The following example clones the "[XMC1300 PMSM FOC Sensorless](https://github.com/Infineon/cce-mtb-xmc1300-pmsm-foc-sl)" application with the desired name "cce-mtb-xmc1300-pmsm-foc-sl" configured for the *KIT_XMC13_BOOT_001* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_XMC13_BOOT_001 --app-id cce-mtb-xmc1300-pmsm-foc-sl --user-app-name cce-mtb-xmc1300-pmsm-foc-sl --target-dir "C:/mtb_projects"
   ```
...
Kit guide|  [XMC1300 boot kit](https://www.infineon.com/dgdl/Board_Users_Manual_XMC1300_CPU_Card_R2.pdf?fileId=db3a30433da5396c013da5d1ef0500b8) – Board user‘s manual. Describes the schematic and hardware of XMC1300 board.
...
Document title: *CCE#002-38219 - XMC&trade;1300 PMSM FOC SL*
